define('UpdateManager', [ 'DefaultSketchCommands', 'sketchLibrary/ProtoSketchFramework',
    'protobufUtils/protobufUtils', 'sketchLibrary/SketchLibraryException' ],
function(CommandException, SketchFramework, protoUtils, SketchException) {
    ...
    var SketchUtil = SketchFramework.GeneralProtos;
    ...
    function UpdateManager(sketchManager, onError) {
        ...
        function executeUpdate(update) {
            ...
            if (inRedoUndoMode) {
                if ((command !== Commands.CommandType.REDO && command !== Commands.CommandType.UNDO)) {
            ...
            if (command === Commands.CommandType.REDO) {
                lastUpdateType = 1;
                if (netCount >= 0) {
                ...
                return redrawRedo;
            } else if (command === Commands.CommandType.UNDO) {
                lastUpdateType = -1;
        ...
        function redoUpdate(update) {
            ...
            if (command.commandType === Commands.CommandType.MARKER) {
                ...
                } else if (marker.type === Commands.Marker.MarkerType.SUBMISSION) {
                ...
                } else if (marker.type === Commands.Marker.MarkerType.SAVE) {
                    if (currentUpdateIndex > lastSavePointer) {
                        lastSavePointer = currentUpdateIndex;
                    }
                }
    ...
    return {
        ...
        UndoRedoException: UndoRedoException,
